...
#define WINDOW_NAME			_T("移動処理")		// ウインドウのキャプション名
...
HRESULT Init(HWND hWnd, BOOL bWindow)
{
	...
	g_pD3DDevice->SetSamplerState(0, D3DSAMP_MINFILTER, D3DTEXF_NONE/*D3DTEXF_LINEAR*/);	// テクスチャ縮小フィルタモードを設定
	g_pD3DDevice->SetSamplerState(0, D3DSAMP_MAGFILTER, D3DTEXF_NONE/*D3DTEXF_LINEAR*/);	// テクスチャ拡大フィルタモードを設定
