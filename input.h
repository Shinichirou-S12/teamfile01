...
/* game pad情報 */
#define LSTICK_UP		0x00000001l	// 方向キー上(.IY<0)
#define LSTICK_DOWN		0x00000002l	// 方向キー下(.IY>0)
#define LSTICK_LEFT		0x00000004l	// 方向キー左(.IX<0)
#define LSTICK_RIGHT	0x00000008l	// 方向キー右(.IX>0)
...
#define RSTICK_UP		0x00004000l // 右スティック方向キー上(.lRy<0)
#define RSTICK_DOWN		0x00008000l	// 右スティック方向キー下(.lRy>0)
#define RSTICK_LEFT		0x00010000l	// 右スティック方向キー左(.lRx<0)
#define RSTICK_RIGHT	0x00020000l	// 右スティック方向キー右(.lRx>0)		
